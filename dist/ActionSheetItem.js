...
var _jsxFileName = "src/ActionSheetItem.js";
...
function ActionSheetItem(_ref) {
  var value = _ref.value,
    ...
    showSelectedIcon = _ref.showSelectedIcon,
  ...
  if (selected && showSelectedIcon) {
    if (["number", "string"].includes(typeof selectedIcon)) {
      iconOnSelected = _react2.default.createElement(_reactNative.Image, {
        source: selectedIcon,
  ...
  if (["number", "string"].includes(typeof icon)) {
    itemIcon = _react2.default.createElement(_reactNative.Image, {
      source: icon,
...
ActionSheetItem.propTypes = {
  ...
  icon: require("prop-types").any,
  selectedIcon: require("prop-types").any,
  selected: require("prop-types").bool,
  showSelectedIcon: require("prop-types").bool,
  onPress: require("prop-types").func,
  style: require("prop-types").any,
  textStyle: require("prop-types").any,
  textComponent: require("prop-types").any
};
